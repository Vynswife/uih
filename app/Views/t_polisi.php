            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?=base_url('home/aksi_t_polisi')?>" method="post" enctype="multipart/form-data">
                                <h4 class="card-title">Penambahan akun polisi</h4>
                                ...
                                <div class="basic-form">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="yourUsername" class="form-label">Lokasi Departemen Penugasan</label>
