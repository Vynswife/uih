                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="<?=base_url('home/profile1/'.session()->get('id'))?>"><i class="icon-user"></i> <span>Profile</span></a>
                                        </li>
                                        
                                        <hr class="my-2">
                                        <li><a href="<?=base_url('home/logout2')?>"><i class="icon-key"></i> <span>Logout</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="http://localhost:8080/home/beranda1" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="http://localhost:8080/home/polisi1">List Polisi</a></li>
                            <li><a href="http://localhost:8080/home/admin2">List Admin</a></li>
                        </ul>
                <?php if(session()->get('level')==1||session()->get('level')==2){?>
                    <li>
                        <a href="http://localhost:8080/home/data1" aria-expanded="false">
